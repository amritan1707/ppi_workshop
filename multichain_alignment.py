...
def main(args):
    ...
    pdb1_path = args.input_pdb
    pdb2_path = args.reference_pdb
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Align homo-oligomers by finding the best pairwise chain matching')
    parser.add_argument('--input_pdb', type=str, required=True, help='Input PDB file to be aligned')
    parser.add_argument('--reference_pdb', type=str, required=True, help='Input PDB file to align to')
    parser.add_argument('--output_pdb', default=None, type=str, help='Aligned PDB file')
